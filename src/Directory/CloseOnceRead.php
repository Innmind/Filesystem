...
final class CloseOnceRead implements Directory, Source
{
    ...
    {
        return new UnsourcedCloseOnceRead($this->directory->add($file));
    }
    ...
    public function remove(Name $name): Directory
    {
        ...
        return new UnsourcedCloseOnceRead($directory);
    }
